public class Heikin {
    public static void main(String[] args) {
        ...
        scores=new int[][]{{126,-36,294,-935,-217,-986},{218,425,221,-126},{524,18,-263},{624,461,-890,-548,211},{-911,154,165,-536,-982,-241}};
        ...
        for (int i = 0; i < times.length; i++)
            System.out.print(i + 1 + "回目:" + times[i] + "[s]" + ((i < times.length-1)? ", ": ""));
        System.out.println();
    ...
    static double calAverage(int[] score){
        ...
        for(int i=0;i< score.length;i++)
            sum=(score[i]<0?sum-score[i]:sum+score[i]);
    ...
    static void printData(String name,int[] time, int[] score, double average ){
        ...
        for(int i=0;i < score.length;i++) {
            System.out.print((i+1)+"回目:"+ (time[i]*1000+score[i])+"[ms]"+"("+score[i]+")"+((i!= score.length-1)?",":""));
